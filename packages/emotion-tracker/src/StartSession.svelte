<script lang="ts">
  ...
  import type { StartSessionProps, StartSessionEvent } from './types';

  // Props for customization
  export let title: string = 'How are you feeling before starting?';
  export let subtitle: string = 'Let us know your current mood';
  export let buttonText: string = 'Start Session';
  export let moodOptions: string[] = ['Happy', 'Neutral', 'Tired', 'Unwell', 'Down'];
