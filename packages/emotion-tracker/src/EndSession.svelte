...
<script lang="ts">
  ...
  // Props with defaults
  export let title: EndSessionProps['title'] = 'How did your session go?';
  export let subtitle: EndSessionProps['subtitle'] = 'Rate your experience';
  export let buttonText: EndSessionProps['buttonText'] = 'Complete Session';
  export let moodOptions: EndSessionProps['moodOptions'] = ['Happy', 'Neutral', 'Tired', 'Unwell', 'Down'];
  export let moodEmojis: EndSessionProps['moodEmojis'] = {
    'Happy': '😊',
    'Neutral': '😐',
    'Tired': '😴',
    'Unwell': '🤒',
  ...
  export let ratingFactors: EndSessionProps['ratingFactors'] = ['Productivity', 'Focus', 'Understanding', 'Energy'];
  export let disabled: EndSessionProps['disabled'] = false;
