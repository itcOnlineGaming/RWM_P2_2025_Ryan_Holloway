...
import { persistSessionStart, persistSessionEnd, getSessions, querySessionsByUser, querySessionsByTimeRange, isValidPreSessionEmotion, logEmotionSelection, persistMidSessionCheckIn, getSessionCheckIns, } from "../events";
describe("events storage", () => {
    ...
    describe("persistSessionStart", () => {
        ...
        it("throws for invalid preSessionEmotion", () => {
            expect(() => persistSessionStart({
                preSessionEmotion: "Joy",
                timestamp: 123,
                sessionId: "s2",
                userId: "u1",
    ...
    describe("persistSessionEnd", () => {
        ...
        it("throws for invalid preSessionEmotion", () => {
            expect(() => persistSessionEnd({
                sessionId: "s1",
                preSessionEmotion: "Invalid",
                postSessionEmotion: "Happy",
                performanceRatings: {},
                distractions: [],
                startTime: 1000,
    ...
    describe("logEmotionSelection", () => {
        ...
        it("uses anonymous as default userId", () => {
            ...
            const stored = localStorage.getItem("emotion_tracker_analytics_anonymous");
            const counters = JSON.parse(stored || "{}");
    ...
    describe("persistMidSessionCheckIn", () => {
        ...
        it("throws for invalid distractions array", () => {
            expect(() => persistMidSessionCheckIn({
                sessionId: "s1",
                timestamp: 1500,
                distractions: [], // empty array
        ...
        it("throws for invalid distraction values", () => {
            expect(() => persistMidSessionCheckIn({
                sessionId: "s1",
                timestamp: 1500,
                distractions: ["InvalidDistraction"],
