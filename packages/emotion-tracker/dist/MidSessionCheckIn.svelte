...
export let title = "Quick distraction check-in";
export let subtitle = "Let us know what is pulling your attention";
export let buttonText = "Save check-in";
export let distractions = ["Phone", "Social media", "Noise", "People", "No distractions"];
...
export let selectedDistractions = [];
export let show = false;
export let disabled = false;
const dispatch = createEventDispatcher();
function toggleDistraction(distraction) {
  if (disabled) return;
