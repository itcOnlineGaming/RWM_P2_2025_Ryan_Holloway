...
import EmotionTracker from '../packages/emotion-tracker/dist/EmotionTracker.svelte';
...
} satisfies Meta<typeof EmotionTracker>;
...
export const Default: Story = {
  args: {
    ...
    customEmotions: ['Happy', 'Neutral', 'Tired', 'Stressed', 'Focused', 'Anxious'],
...
export const WorkSession: Story = {
  args: {
    ...
    performanceFactors: ['Task Completion', 'Code Quality', 'Problem Solving', 'Creativity'],
    theme: 'dark',
  },
};
